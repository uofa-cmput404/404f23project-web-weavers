...
class InboxView(APIView, PageNumberPagination):
    ...
    def post(self, request, author_id):
        ...
        if request.data["type"] == "Follow":
            try:
                ...
                follow_requester = self._get_remote_author(request.data["actor"])
            ...
            try:
                ...
                like_sender = self._get_remote_author(request.data["author"])
            ...
            try: 
                ...
                post = self._get_remote_post(request.data["id"])
    ...
    def _get_remote_author(self, remote_author_url):
